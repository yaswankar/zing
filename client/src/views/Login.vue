<template>
    ...
    <div class="pages">
        ...
        <div class="input">
            ...
            <input class="text" type="text" v-model="email" placeholder=""/>
        </div>
        <div class="input">
            <div class="title">PASSWORD</div>
            <input class="text" type="password" v-model="password" placeholder=""/>
        </div>
        <div class="input">
            <input type="submit" @click="login" value="ENTER"/>
        </div>
        </div>
        ...
        <div class="input">
            <input type="submit" @click="register" value="SIGN ME UP!"/>
        </div>
        </div>
    </div>
    <div class="tabs">
